...
UniValue addnode(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("addnode", "\"192.168.0.6:34558\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.0.6:34558\", \"onetry\"")
        );
...
UniValue disconnectnode(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("disconnectnode", "\"192.168.0.6:34558\"")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:34558\"")
        );
...
UniValue getaddednodeinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw runtime_error(
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:34558\", (string) The dogecoin server IP and port we're connected to\n"
